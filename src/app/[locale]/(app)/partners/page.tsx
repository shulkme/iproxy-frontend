      ...
      <div className="bg-blue-500/5 border border-blue-100 rounded-sm p-8 relative overflow-hidden">
        ...
        <div className="space-y-2 relative z-10">
          ...
          <p className="text-black/50">
            Gathering various tools and cooperation resources to build an
            expandable data ecosystem
          </p>
          <p className="text-black/50">
            <span>Want to become a partner? Contact us, </span>
            <a>support@xxx.com</a>
          </p>
        </div>
      </div>
